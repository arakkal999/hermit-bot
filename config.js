...
module.exports = {
  VERSION: 'v4.4.4',
  SESSION_ID: process.env.SESSION_ID || 'HP_2024_OCT_10_BY1GY0',
  MODE: (process.env.MODE || 'private').toLowerCase(),
  HANDLERS: (process.env.PREFIX || '☆͜͡➳').trim(),
  ...
  STICKER_DATA: process.env.STICKER_DATA || '⚔️⃤𝚸͢𝚫͢𝚩͢𝐋͢𝚯͢   ͢  ͢𝐒͢𝚵͢𝚪⃝᭄͢🏴‍☠️͢࿐',
  ERROR_MESSAGE: toBool(process.env.ERROR_MESSAGE, 'true'),
  SONG_THUMBNAIL: toBool(process.env.SONG_THUMBNAIL),'⚔️⃤𝚸͢𝚫͢𝚩͢𝐋͢𝚯͢   ͢  ͢𝐒͢𝚵͢𝚪⃝᭄͢🏴‍☠️͢࿐'
  ...
  RENDER_NAME: process.env.RENDER_NAME || 'ᴩᴀʙʟᴏ ꜱɪʀ',
  ...
  RBG_API_KEY: process.env.REMOVE_BG_API_KEY || 'rnd_i98UH9dNJTgECbEaleTdV9toWCBk',
